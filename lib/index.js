...
Mehdown.archiveOrg = function(entry) {
    return '<iframe src="https://archive.org/embed/' + entry + '" width="560" height="384" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>';
};
