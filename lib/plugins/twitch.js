            ...
            if (href) {
                ...
                if (textToken && textToken.content && regExp.test(textToken.content)) {
                    ...
                    if (matches && matches[1]) {
                        ...
                        return `<iframe allowfullscreen="true" class="twitch-video" frameborder="0" src="http://player.twitch.tv/?channel=${channel}&muted=true"></iframe><iframe class="twitch-chat" frameborder="0" src="http://www.twitch.tv/${channel}/chat"></iframe>`;
                    }
                }
            }
        }
